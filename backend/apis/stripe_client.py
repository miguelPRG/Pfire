...
async def create_checkout(user_id: str, plan_id: str, stripe_customer_id: str) -> dict:
    ...
    try:
        ...
        if not stripe_customer_id:
            ...
            raise Exception("Customer Stripe ausente. O utilizador deve ter um customer antes do checkout.")
        ...
        if trial_subs.data:
            ...
            raise Exception(f"Você já tem um plano em período de teste. Cancele o atual antes de contratar outro.")
