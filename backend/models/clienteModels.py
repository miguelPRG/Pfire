...
class ClienteCreate(BaseModel):
    nome: str = Field(
        ...,
        max_length=100,
        description="Nome do cliente. Deve ter no máximo 100 caracteres.",
    )
    ...
    localidade: str = Field(
        ...,
        max_length=100,
        description="Localidade do cliente. Deve ter no máximo 100 caracteres.",
    )
    morada: str = Field(
        ...,
        max_length=255,
        description="Morada do cliente. Deve ter no máximo 255 caracteres.",
    )
...
class ClienteUpdate(BaseModel):
    ...
    email: Optional[EmailStr] = Field(
        None,
        max_length=254,
        description="O email deve ser um endereço de email válido.",
    )
    ...
    localidade: Optional[str] = Field(
        None,
        max_length=100,
        description="Cidade do cliente. Deve ter no máximo 100 caracteres.",
    )
    morada: Optional[str] = Field(
        None,
        max_length=255,
        description="Morada do cliente. Deve ter no máximo 255 caracteres.",
    )
...
class ClienteActivion(BaseModel):
    id: str = Field(
        ...
        min_length=24,
        max_length=24,
        description="ID do cliente a ser ativado/desativado.",
    )
    empresa_id: str = Field(
        ...,
        min_length=24,
