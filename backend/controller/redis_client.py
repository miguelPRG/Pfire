...
redis_host = os.getenv("REDIS_HOST", "cunning-lamb-12871.upstash.io")
redis_port = int(os.getenv("REDIS_PORT", "6379"))
redis_password = os.getenv("REDIS_PASSWORD", "ATJHAAIjcDE4OTIxZGI3NThjNzU0MjViOGI4OTM4YTM2MWJlODgyOHAxMA")
